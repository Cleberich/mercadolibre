...
export default function Ubicacion() {
    const [spinnerr, setSpinnerr] = useState(true)
    const {obtenerUbicacion, setUbicacion} = useMl()
    useEffect(()=>{
        setTimeout(()=>{
            setSpinnerr(false)
        }, 2000)
  ...
  return (
       ...
       {spinnerr ? (
        ...
        <div className="ubicacion p-3 bg-white">
        ...
        <form className="mt-3" onSubmit={obtenerUbicacion}>
